...
set "X86_SAMPLES=DInput8Sample.exe D3D9Sample.exe D3D10Sample.exe D3D11Sample.exe D3D12Sample.exe DXGISample.exe"
set "X64_SAMPLES=DInput8Sample64.exe D3D9Sample64.exe D3D10Sample64.exe D3D11Sample64.exe D3D12Sample64.exe DXGISample64.exe"
set "X86_DLLS=dinput8.dll d3d9.dll d3d10.dll d3d11.dll d3d12.dll dxgi.dll"
set "X64_DLLS=dinput8.dll d3d9.dll d3d10.dll d3d11.dll d3d12.dll dxgi.dll"
