...
7za a -tzip ".\bin\ExeUnprotect-Win32.zip" ".\bin\Win32\Release\scripts\ExeUnprotect.asi"
7za a -tzip ".\bin\RE7Demo.InfiniteAmmo-x64.zip" ".\bin\x64\Release\dinput8.dll" ".\bin\x64\Release\scripts\RE7Demo.InfiniteAmmo.asi" ".\bin\place both files in RESIDENT EVIL 7 biohazard Demo folder"
...
7za a -tzip ".\bin\VirtualFileServer-x64.zip" ".\bin\x64\Release\VirtualFileServer.exe" ".\source\demo_plugins\plugins\"
EXIT
